...
class _Combobox02State extends State<Combobox02> {
  String? pilihKategori; // Variabel untuk menyimpan kategori yang dipilih
  String? pilihItem; // Variabel untuk menyimpan item yang dipilih
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            Text(
              pilihKategori != null && pilihItem != null
                  ? 'Kategori: $pilihKategori, Item: $pilihItem'
                  : 'Belum ada pilihan',
